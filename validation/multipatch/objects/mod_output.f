...
# 1 "sources/output/output_mesh.f" 1
!---------------------------------------------------------------------------------!
! output_mesh.f
!---------------------------------------------------------------------------------!
! <<HEADER>>
...
! WRITE(17,'(3A)') '      <PDataArray type="',float_type, &
! & '" Name="dvort" NumberOfComponents="3" format="appended" offset="0"/>'
...
! WRITE(asciiline,'(3A,I10,A)')'<DataArray type="',float_type, &
! & '" Name="dvort" NumberOfComponents="3" format="appended" offset="', &
! & nbytes,'"/>'
! WRITE(10)TRIM(asciiline)
! nbytes = nbytes + 3*ndata*prec_output
...
! vorticity
    DO k=1, ncell(3)
      ...
      END DO
    END DO
! material derivative of vorticity
! DO k=1, ncell(3)
! DO j=1, ncell(2)
! DO i=1, ncell(1)
! WRITE(10) REAL(mesh%dvort(1,i,j,k),prec_output)
! WRITE(10) REAL(mesh%dvort(2,i,j,k),prec_output)
! WRITE(10) REAL(mesh%dvort(3,i,j,k),prec_output)
! END DO
! END DO
! END DO
